...
def print_enrolment_material(email: str, secret: str, codes: list[str]) -> None:
    ...
    print(f"    Key          : {secret}")
    print(f"    (easier to type: {grouped})")
    ...
    print()
    print("    PASTE THE UNSPACED KEY. Aegis (and other strict apps) validate base32 and reject")
    print("    the spaces outright — 'secret is not a valid base32'. The grouped form above is a")
    print("    reading aid for typing by hand; strip the spaces if you paste it.")
    print()
