...
- **Catalysts:** Q2 CC ~mid-July (likely another guide raise); US-Taiwan tariff deal finalize (removes overhang); **non-obvious:** Intel 18A / Samsung 2nm *failing to close the gap* extends pricing power past 2027; Taiwan power/water is the real near-term bottleneck (and a reshoring accelerant).
- **Falsification:** N2 yield/ASP disappoints, customers reject hikes, hyperscaler capex air-pocket, a rival lands a marquee N2-class win below TSM price by mid-2027, or sharp China escalation.
- **Role:** structural-AI anchor / core hold.

## PLTR — Palantir · **conviction MED** (size-aware)
**Core thesis (trade 1–6mo; structural 2–3yr):** Elite, *accelerating* business (rev +85%, Rule-of-40 145%) bolted to a valuation (~115x P/S) that prices perfection — so it's **the inverse of TSM**: business right, stock vulnerable to multiple compression even on good prints until growth out-runs an already-raised bar.
- **Forward drivers:** US commercial +133% (the real engine), Golden Dome + defense "OS" land-grab, AIP/bootcamp flywheel; DOGE efficiency mandate is a *tailwind* (PLTR = the consolidation layer), not the assumed cut-risk.
- **Expectations gap:** *downside* under-appreciated — the whisper bar moved, so a 70%+ print can still disappoint (YTD -26% despite the beat). High-beta + long-duration → most exposed to any hawkish-rate surprise.
- **Catalysts:** Q2 ~August (needs US-comm to hold >100% + another raise); Golden Dome award sizing; **non-obvious:** momentum/flows unwind, hyperscaler AI-platform encroachment.
...
- **Catalysts:** **CLARITY Act** floor vote (live 2026 catalyst — *not* GENIUS/June 17); Mastercard's June 3 on-chain settlement launch (bullish *read-through* for V's same strategy); **non-obvious:** GENIUS/CLARITY's real winner = settlement-utility + agentic commerce (V is building agent-pay); real *loser* = correspondent-bank cross-border float, not V interchange.
