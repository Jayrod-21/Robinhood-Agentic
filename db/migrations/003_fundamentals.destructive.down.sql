-- 003_fundamentals (down) — drop the fundamentals snapshot table and its point-in-time accessor.
--
...
DROP FUNCTION IF EXISTS fundamentals_asof(BIGINT, TIMESTAMPTZ, TEXT);
